        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryId = table.Column<long>(type: "bigint", nullable: false),
                    ExternalProductId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoundLocally = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SecurityEventId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SecurityEventType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SecurityEvents_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SafetyStockLevel = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ProcurementLeadTimeDays = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcurementStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Procurements_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurements_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurements_Products_ProductId1",
                        column: x => x.ProductId1,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Procurements_OrderId",
                table: "Procurements",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Procurements_ProductId",
                table: "Procurements",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Procurements_ProductId1",
                table: "Procurements",
                column: "ProductId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityEvents_CreatedDate",
                table: "SecurityEvents",
                column: "CreatedDate");

            migrationBuilder.CreateIndex(
                name: "IX_SecurityEvents_SecurityEventType",
                table: "SecurityEvents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityEvents_UserId1",
                table: "SecurityEvents",
                column: "UserId1");
